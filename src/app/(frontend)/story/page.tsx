...
export const metadata: Metadata = {
  title: "Our Story",
  description:
    "Verboten is an independent beverage house in Pretoria. Founded in 2020, releasing brandy in limited editions, and building toward shelves in Amsterdam and Berlin.",
